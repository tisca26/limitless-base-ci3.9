...
<div class="page-header page-header-light">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">Menú</span> - Insertar</h4>
    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Insertar</span>
            </div>
            <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
        </div>
...
<div class="content">
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">Inserción de menú</h5>
        ...
        <div class="card-body">
            ...
            <?php echo form_open('menu/frm_insertar', array('id' => 'form1', 'class' => 'form-validate-jquery')); ?>
            <div class="row">
                <div class="col-md-12">
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo form_input('shortdesc', set_value('shortdesc', ''), $data_shortdesc); ?>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo form_dropdown('parent_id', $menus, '', 'class="form-control select-search" data-fouc') ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <?php echo form_dropdown('resource_id', $recursos, '', 'id="resource_id" class="form-control select-search" data-fouc') ?>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-group">
                                                ...
                                                <?php echo form_input('page_res', set_value('page_res', ''), $data_page_res); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <?php echo form_input('page_uri', set_value('page_uri', ''), $data_page_uri); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo form_input('icon', set_value('icon', ''), $data_icon); ?>
                                </div>
                            </div>
                        </div>
                    </fieldset>
