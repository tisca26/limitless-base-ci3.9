...
<div class="page-header page-header-light">
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><span class="font-weight-semibold">Usuarios</span> - Insertar</h4>
...
<div class="content">
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">Inserción de usuarios</h5>
        ...
        <div class="card-body">
            ...
            <?php echo form_open('users/frm_insertar', array('id' => 'form1', 'class' => 'form-validate-jquery')); ?>
            <div class="row">
                <div class="col-md-6">
                    <fieldset>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <input name="passwd" type="text" class="form-control"
                                   placeholder="Dejar en blanco si no se modifica" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input name="estatus" type="checkbox" class="form-check-input-styled" value="1" <?php echo set_checkbox('estatus', 1, TRUE); ?>
                                           data-fouc>
                                    ¿Activo?
                                </label>
                            </div>
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input name="groups[]" type="checkbox" class="form-check-input-styled" value="<?php echo $grupo->groups_id; ?>"
                                               data-fouc <?php echo set_checkbox('groups[]', $grupo->groups_id, false); ?>>
