...
class Groups extends Privy
{
    ...
    public function index()
    {
        ...
        $template['_B'] = 'groups/groups_index';
        $template['_S'] = 'groups/groups_index';
        $this->load->template_view($this->plantilla, $data, $template);
    }

    public function insertar()
    {
        $template['_B'] = 'groups/groups_insertar';
        $template['_S'] = 'groups/groups_insertar';
    ...
    public function editar($id = 0)
    {
        ...
        $template['_B'] = 'groups/groups_editar';
        $template['_S'] = 'groups/groups_editar';
        $this->load->template_view($this->plantilla, $data, $template);
    }
