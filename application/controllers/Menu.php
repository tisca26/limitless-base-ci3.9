...
class Menu extends Privy
{
    ...
    public function index()
    {
        ...
        $data['navlist'] = $tree;
        $template['_B'] = 'menu/menu_index';
        $template['_S'] = 'menu/menu_index';
    ...
    public function insertar()
    {
        ...
        $template['_B'] = 'menu/menu_insertar';
        $template['_S'] = 'menu/menu_insertar';
        $this->load->template_view($this->plantilla, $data, $template);
    }
    ...
    public function editar($id = 0)
    {
        ...
        $template['_B'] = 'menu/menu_editar';
        $template['_S'] = 'menu/menu_editar';
        $this->load->template_view($this->plantilla, $data, $template);
    }
